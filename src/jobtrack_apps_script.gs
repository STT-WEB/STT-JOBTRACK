...
var PHOTO_RETENTION_DAYS = 31;               // เก็บรูป 31 วัน = ครอบคลุมงวดเงินเดือน 1 งวดเต็ม (ตัดงวดวันที่ 26) แล้วลบอัตโนมัติทุกวันตี 2
...
var T_1930 = 19 * 60 + 30; // 1170 — จบ OT บล็อก 1 · เริ่มพักเย็น
var T_2000 = 20 * 60;      // 1200 — จบพักเย็น · เริ่ม OT บล็อก 2
...
function getDayTypeBands(dayKind) {
  ...
  return [
    ...
    /* ★ กรอบ OT มาตรฐาน : 17:00–19:30 · พักเย็น 19:30–20:00 · 20:00–00:00
       ช่วง 19:30-20:00 ไม่มี band = ตัดพักเย็นทิ้งอัตโนมัติเหมือนพักเที่ยง */
    { from: T_1700, to: T_1930, code: otCode },     // 17:00-19:30 OT บล็อก 1
    { from: T_2000, to: 1440,   code: otCode },     // 20:00-24:00 OT บล็อก 2+3
  ];
}
